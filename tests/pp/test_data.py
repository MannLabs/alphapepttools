...
@pytest.mark.parametrize(
    ("expected_columns", "expected_rows", "max_missing", "action", "group_column", "groups"),
    [
        ...
        # 1.1.1 Filter columns with 0.5 threshold - flag
        (
            ["A", "B", "C"],
            ["cell1", "cell2", "cell3", "cell4", "cell5"],
            0.5,
        ...
        # 1.2. Filter columns with 0.6 threshold so that one value lies exactly on the threshold --> this should be kept since ">" is used - flag
        (
            ["A", "B", "C", "D"],
            ["cell1", "cell2", "cell3", "cell4", "cell5"],
            0.6,
